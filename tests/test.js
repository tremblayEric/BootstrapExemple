...
casper.test.begin("Chargement de la page", 1, function(test) {
    ...
    casper.start('http://localhost:8000/vue.html', function(){
        test.assertTitle('Dossier Comptable','Validation du titre');
    });
...
casper.test.begin("Validation du selecteur de client", 2, function(test) {
    ...
    casper.start('http://localhost:8000/vue.html', function(){
        test.assertExists('#numeroDossier','Élement \'numeroDossier\' existe');
        test.assertVisible('#numeroDossier','Élement \'numeroDossier\' est visible');
    });
...
casper.test.begin("Validation des accordeons", 2, function(test) {
    ...
    casper.start('http://localhost:8000/vue.html', function(){
        test.assertExists('#page','Élement page existe');
        test.assertNotVisible('#page','Élement \'page\' n\'est pas visble par défaut');
    });
    casper.run(function(){
        test.done();
    }
...
casper.test.begin('remplir le formulaire membres',5, function suite(test) {
    ...
    casper.start("http://localhost:8000/vue.html", function() {
        ...
        this.wait(500,function(){
            test.assertFieldCSS("#numeroDossier", "12345",'Le numéro de dossier égale \'1234\'');
            this.capture('test.png');
            this.click('#accordeonDossierUn');
            this.wait(500,function(){
                test.assertVisible('#page','Élement \'page\' est maintenant visible');
                ...
                this.wait(500,function(){
                    ...
                    this.wait(500,function(){
                        test.assertVisible('#noteCredit','Élement \'noteCredit\' est maintenant visible');
                        ...
                        this.wait(500,function(){
                            ...
                            test.assertMatch(newTotal,/^172.86/,'Le total égale 172.86');
                            this.evaluate(function(){
                            ...
                            this.wait(500,function(){
                                ...
                                test.assertMatch('projet10',/^projet10/,'Le projet porte maintenant le nom \'projet10\'');
...
casper.test.begin('Test des Liens des onglets du Dossier 1',2, function suite(test) {
    casper.start("http://localhost:8000/vue.html", function() {
        test.assertExists('a[href="#aRecevoir"]','Élement \'aRecevoir existe\'');
        test.assertExists('a[href="#aPayer"]','Élement \'aPayer\' existe');
...
casper.test.begin('Test des Liens de l\'onglet \'A recevoir\' du Dossier 1',5, function suite(test) {
    casper.start("http://localhost:8000/vue.html", function() {
        test.assertExists('a[href="#livre"]','Élement \'livre\' existe');
        test.assertExists('a[href="#abonnement"]','Élement \'abonnement\' existe');
        test.assertExists('a[href="#mobilier"]','Élement \'mobilier\' existe');
        test.assertExists('a[href="#divers"]','Élement \'divers\' existe');
        test.assertExists('a[href="#materiaux"]','Élement \'materiaux\' existe');
...
casper.test.begin('Test  ouverture de la facture', 35, function suite(test) {
    ...
    casper.start("http://localhost:8000/vue.html", function() {
        ...
        this.wait(500, function() {
            ...
            test.assertExists("#result","L'entête de la facture existe");
            test.assertVisible("#result","L'entête de la facutre est visible");
            ...
            //item1
            test.assertVisible("#qteItem1","Le champs de quantité  l'item1 est visible");
            ...
            test.assertNotVisible("#credit1","Le champs de note de crédit  l'item1 est non visible");
            //item2
            test.assertVisible("#qteItem2","Le champs de quantité  l'item2 est visible");
            ...
            test.assertNotVisible("#credit2","Le champs de note de crédit  l'item2 est non visible");
            //item3
            test.assertVisible("#qteItem3","Le champs de quantité  l'item3 est visible");
            ...
            test.assertNotVisible("#credit3","Le champs de note de crédit  l'item3 est non visible");
            ...
            test.assertExists('#btnNoteCredit',"Il existe un element \'btnNoteCredit\'");
            test.assertEquals(this.getElementAttribute('#btnNoteCredit', 'type'),"button","L'élement \'btnNoteCredit\' est un bouton");
